            ...
            <div className="fixed inset-0 flex">
              ...
              >
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-woodsmoke-950 px-6 pb-4">
                    <div className="flex h-16 shrink-0 items-center">
                      <Link href={"/"}>
                        <Image src={Logo} alt="your logo" loading="eager" />
                      </Link>
                    </div>
                                ...
                                <a
                                  ...
                                  className={classNames(
                                    item.current
                                      ...
                                      : "text-white hover:text-white hover:bg-woodsmoke-900",
                      ...
                      <li key={item.name}>
                        <a
                          ...
                          className={classNames(
                            item.current
                              ? "bg-woodsmoke-900 text-white"
                              : "text-gray-200 hover:text-white hover:bg-woodsmoke-900",
                            "group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
                          )}
                        >
                          <item.icon
